...
(function ($) {
        ...
        var that = {
            ...
            redraw: function () {
                ...
                particleSystem.eachEdge(function (edge, pt1, pt2) {
                    ...
                    ctx.beginPath()
                    ctx.lineWidth = 2
                    ctx.strokeStyle = (color) ? color : 'rgba(150,150,150,1)'
                    ...
                    ctx.fillStyle = (color) ? color : 'rgba(50,50,50,1)'
    ...
    $(document).ready(function () {
        ...
        var sys = arbor.ParticleSystem(1000, 900, 0.9) // create the system with sensible repulsion/stiffness/friction
