    ...
    public static List<Nodo> getNodos(Statement s, Nodo fin, int Id) {
        ...
        switch (Statements.getIndexStatement(s)) {
            ...
            case TryStmt:
                ...
                inicio.addSiguiente(tryNodos.get(0));
                ...
                for (CatchClause catch1 : catchs) {
                    nodos = getNodosCatch(catch1, finTemp, null, Id);
                    Id = Id + nodos.size();
                    if (nodos.size() > 0) {
                        ...
                        if (iniAlt == null) {
                            ...
                            iniAlt.addSiguiente(nodos.get(0));
                        }
                        
                    }
                }
                if (iniAlt != null) {
                    inicio.addSiguiente(iniAlt);
                }
