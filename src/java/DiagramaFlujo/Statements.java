...
import static DiagramaFlujo.Statements.ForStmt;
import static DiagramaFlujo.Statements.getIndexStatement;
...
public class Statements {
            ...
            case BlockStmt:
                ...
                if (stmts != null) {
                    ...
                    for (Statement tempS : stmts) {
                        ...
                        if (index > 0) {
                            setNullSiguiente(resultado, ifTemp, false);
                        }
   ...
   public static void setNullSiguiente(List<Nodo> nodos, Nodo fin, boolean alternativo) {
    ...
    static void setNullSiguienteAlt(List<Nodo> nodos, Nodo fin) {
        for (Nodo nodo : nodos) {
